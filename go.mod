module github.com/cosign-verifier

go 1.18

require (
	github.com/dlorenc/cosigned v0.0.0-20211119195501-934e28a616da
...
require (
	...
	github.com/sigstore/cosign v1.0.1-0.20210728181701-5f1f18426dc3 // indirect
